    ...
    return (
        <Layout>
            <div id="announcement" className="text-3xl text-slate-900 bg-blue-400 h-20 flex items-center rounded-xl mt-2 mb-5">
                <h1 className="ml-5">Assignment</h1>
            </div>

            <div id="title" className="text-3xl text-slate-900 bg-blue-300 h-20 flex items-center rounded-xl mt-5 mb-5">
                <h1 className="ml-5">Title of the Assignment</h1>
            </div>

            <div id="description" className="text-2xl text-slate-900 bg-blue-300/80 h-40 flex rounded-xl mt-5 mb-5">
            ...
            <div id="resource_attachment" className="h-20 p-3">
                <h1>Attachment will appear here</h1>
            </div>
