...
const arrayIcon = [<AcademicCapIcon key={1} fontSize="small" className={Style} />, <HomeIcon key={2} fontSize="small" className={Style} />, <BookOpenIcon key={3} fontSize="small" className={Style} />, <UserGroupIcon key={4} fontSize="small" className={Style} />, <SpeakerphoneIcon key={5} fontSize="small" className={Style} />]
