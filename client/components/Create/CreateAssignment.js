        ...
        <Layout>
            <div className="flex justify-center items-center relative">
                <div className="flex flex-col items-center bg-white/20 backdrop-blur-sm h-[600px] w-[800px] rounded-xl shadow-xl backdrop-filter overflow-hidden shadow-purple-100/10">
                    ...
                    <div className="text-center text-3xl mt-10">Create Assignment</div>
                    <form>

                        <div className="flex flex-col">
                            <textarea type="text" name="" id="" className="mt-16 p-2 rounded-lg backdrop-blur-md shadow-md text-black h-10 w-96" placeholder='Title' style={{resize:"none"}} required></textarea>
                        </div>

                        <div className="flex flex-col">
                            <textarea type="text" name="" id="" className="mt-16 mb-8 p-2 rounded-lg backdrop-blur-md shadow-md text-black h-24 w-96" placeholder='Instruction' style={{resize:"none"}}></textarea>
                        </div>
